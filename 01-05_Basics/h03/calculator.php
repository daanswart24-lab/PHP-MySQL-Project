...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (
        isset($_POST['distance'], $_POST['gallon_price'], $_POST['efficiency'])
        ...
        echo '<h1>Total Estimated Cost</h1>
                ...
                avering ' . $_POST['efficiency'] . ' miles 
                per gallon, and paying an averege of $' . number_format($_POST['gallon_price'], 2)
            . ' per gallon is $' . number_format($dollars, 2) . '. If you drive at an average 
                of 65 miles per hour, the trip will take approximately ' .
...
<form action="calculator.php" method="post">
    <p>Distance (miles): <input type="text" name="distance"></p>
